...
class SESMeasure:
    ...
    def MeasureAnalyzerRegion(self, region, data=None, updatefreq="slice", path=None):
        ...
        slice_scale = self.ses.GetAcquiredDataArray(
            "acq_slice_scale", slices, data=None
        )
        channel_scale = self.ses.GetAcquiredDataArray(
            "acq_channel_scale", channels, data=None
        )
