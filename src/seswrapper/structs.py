...
class DetectorRegion(ctypes.Structure):
    ...
    def __iter__(self):
        d = {
            "firstXChannel": self.firstXChannel_,
...
class DetectorInfo(ctypes.Structure):
    _fields_ = [
        ("timerControlled_", ctypes.c_bool),
        ...
        ("discPresent_", ctypes.c_bool),
    ]  ###this may actually be a bool? It's true or false

    def __iter__(self):
        d = {
            "timerControlled": self.timerControlled_,
